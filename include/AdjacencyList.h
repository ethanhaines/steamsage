...
public:
    ...
    void initialize_graph(std::string game, std::vector<std::string> tags, std::unordered_map<std::string, std::vector<std::string>>& games, std::unordered_map<std::string, int>& tag_freq, int size, int match_requirement);
private:
